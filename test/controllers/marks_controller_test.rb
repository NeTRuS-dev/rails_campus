...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { student_info_id: @mark.student_info_id, subject_id: @mark.subject_id, value: @mark.value } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { student_info_id: @mark.student_info_id, subject_id: @mark.subject_id, value: @mark.value } }
