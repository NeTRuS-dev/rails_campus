...
class VacanciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacancy" do
    assert_difference('Vacancy.count') do
      post vacancies_url, params: { vacancy: { description: @vacancy.description, position: @vacancy.position, title: @vacancy.title, wage: @vacancy.wage } }
    end
  ...
  test "should update vacancy" do
    patch vacancy_url(@vacancy), params: { vacancy: { description: @vacancy.description, position: @vacancy.position, title: @vacancy.title, wage: @vacancy.wage } }
